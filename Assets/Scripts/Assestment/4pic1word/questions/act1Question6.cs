...
public class act1Question6 : MonoBehaviour
{
    ...
    List<char> AnswerCase = new List<char> { 't', 'r', 'u', 'e' };
    ...
    {
        return correctLeterLabel[0].text == "t" && correctLeterLabel[1].text == "r" && correctLeterLabel[2].text == "u" && correctLeterLabel[3].text == "e";
    }
