...
public class act1Question7 : MonoBehaviour
{
    ...
    List<char> AnswerBreak = new List<char> { 'f', 'a', 'l', 's', 'e' };
    ...
    {
        return correctLeterLabel[0].text == "f" && correctLeterLabel[1].text == "a" && correctLeterLabel[2].text == "l" && correctLeterLabel[3].text == "s" && correctLeterLabel[4].text == "e";
    }
