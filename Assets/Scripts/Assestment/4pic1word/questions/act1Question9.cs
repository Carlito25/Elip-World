...
public class act1Question9 : MonoBehaviour
{
    ...
    List<char> AnswerBreak = new List<char> { 'w', 'h', 'i', 'l', 'e' };
    ...
    {
        return correctLeterLabel[0].text == "w" && correctLeterLabel[1].text == "h" && correctLeterLabel[2].text == "i" && correctLeterLabel[3].text == "l" && correctLeterLabel[4].text == "e";
    }
