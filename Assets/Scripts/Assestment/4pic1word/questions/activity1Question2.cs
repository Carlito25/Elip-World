...
public class activity1Question2 : MonoBehaviour
{
    ...
    List<char> AnswerSwitch = new List<char> { 's', 'w', 'i', 't', 'c', 'h' };
    ...
    {
        return correctLeterLabel[0].text == "s" && correctLeterLabel[1].text == "w" && correctLeterLabel[2].text == "i" && correctLeterLabel[3].text == "t" && correctLeterLabel[4].text == "c" && correctLeterLabel[5].text == "h";
    }
