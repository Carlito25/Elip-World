...
public class activity1code : MonoBehaviour
{
    ...
    {
        return correctLeterLabel[0].text == "b" && correctLeterLabel[1].text == "r" && correctLeterLabel[2].text == "e" && correctLeterLabel[3].text == "a" && correctLeterLabel[4].text == "k";
    }
