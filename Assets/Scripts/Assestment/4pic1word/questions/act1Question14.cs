...
public class act1Question14 : MonoBehaviour
{
    ...
    List<char> AnswerCase = new List<char> { 'o', 'n', 'l', 'y' };
    ...
    {
        return correctLeterLabel[0].text == "o" && correctLeterLabel[1].text == "n" && correctLeterLabel[2].text == "l" && correctLeterLabel[3].text == "y";
    }
