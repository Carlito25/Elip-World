...
public class act1Question4 : MonoBehaviour
{
    ...
    List<char> AnswerCase = new List<char> { 'l', 'o', 'o', 'p' };
    ...
    {
        return correctLeterLabel[0].text == "l" && correctLeterLabel[1].text == "o" && correctLeterLabel[2].text == "o" && correctLeterLabel[3].text == "p";
    }
