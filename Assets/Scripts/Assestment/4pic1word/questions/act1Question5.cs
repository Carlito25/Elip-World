...
public class act1Question5 : MonoBehaviour
{
    ...
    List<char> AnswerBreak = new List<char> { 't', 'h', 'r', 'e', 'e' };
    ...
    {
        return correctLeterLabel[0].text == "t" && correctLeterLabel[1].text == "h" && correctLeterLabel[2].text == "r" && correctLeterLabel[3].text == "e" && correctLeterLabel[4].text == "e";
    }
